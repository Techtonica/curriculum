...
_⚠️ Note: This starter code has intentional limitations - it doesn't check for many edge cases, doesn't validate domain specifics, and uses a simplistic regex that could allow invalid emails._
