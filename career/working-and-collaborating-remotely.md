...
### Challenge
PivotalTracker is a commercial grade management system used for software development that also offers a free tier. With 1 or 2 fellow apprentices, or even colleagues outside of Techtonica, set up either a small project or a pact to update your portfolio sites. Have each sign up for a [PivotalTracker](https://www.pivotaltracker.com/) account. Communicate by Slack, Hangouts or Zoom to simulate working remotely.

Discuss and create a set of Issues (or use current ones) that each person could do in one week and assign a "Team Lead". Work together to help the Team Lead navigate adding “Stories” based on those Issues to the Pivotal Tracker “Icebox”, assigning “Points” and “Tasks” within those stories based on the Issues.  Have the Team Lead move those stories into the “Current Iteration” section and assign them to the appropriate team member. As you progress, figure out how to get finished assignments reviewed and into the PivotalTracker "Done" section with the Team Lead. Finally, select the next Team Lead, and continue until everyone has been Team Lead.
