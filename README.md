...
1. [Learning to Learn:Group Activity](/learning-to-learn/learning-to-learn.md)
1. [Assignment and Assesment Submission Process](https://docs.google.com/document/d/1zXhHpAOO35ecO6TBOyOcFG-QyYyciDw1xfqIfOxbozY) 
...
1. [🎒Homework: Book Series - You Don't Know JS - Book #1 Getting Started - Ch 1 & 2](https://github.com/getify/You-Dont-Know-JS/blob/2nd-ed/get-started/README.md)
...
1. [HTML](/html/html.md)
1. [🎒Homework: Personal Career Branding](/personal-brand/personal-branding.md) 
1. [🎒Homework: Book Series - You Don't Know JS - Book #1 Getting Started - Ch 3 & 4](https://github.com/getify/You-Dont-Know-JS/blob/2nd-ed/get-started/README.md)
1. [How the Internet Works (The Other Kind of Networking)](/networking-computing/how-the-internet-works.md)
1. [What is DNS](/networking-computing/intro-to-dns-ip.md)
1. [Git and Version Control](/git/git-version-control.md)
1. [.gitignore](/git/gitignore.md)
1. [🎒Homework: Gists, order your business cards](https://help.github.com/en/enterprise/2.13/user/articles/about-gists)
1. [Recipe Page Project](/projects/recipe-page/phase-1-html-prompt.md)
1. [Using GitHub for Code Storage](/git/github-storage.md)
1. [Week 1 Worksheet](/projects/week-1-worksheet.md)
1. [🎒Homework: Book Series - You Don't Know JS - Book #2 Scope & Closures - Ch 1 & 2](https://github.com/getify/You-Dont-Know-JS/blob/2nd-ed/scope-closures/README.md) 
...
1. [🎒Homework: UI/UX Design](/ui-ux-design/ui-ux-design.md)
1. [🎒Homework: Book Series - You Don't Know JS - Book #2 Scope & Closures - Ch 3](https://github.com/getify/You-Dont-Know-JS/blob/2nd-ed/scope-closures/README.md)
1. [🎒Homework: Book Series - Eloquent JavaScript - Chapter 1 & 2 + Exercises ](https://eloquentjavascript.net/Eloquent_JavaScript.pdf)
...
1. [🎒Homework: Web design patterns](/web-patterns/web-patterns.md)
1. [🎒Homework: Book Series - You Don't Know JS - Book #2 Scope & Closures - Ch 4](https://github.com/getify/You-Dont-Know-JS/blob/2nd-ed/scope-closures/README.md)   
1. [🎒Homework: Book Series - Eloquent JavasScript - Chapter 3 + Exercises ](https://eloquentjavascript.net/Eloquent_JavaScript.pdf) 
...
1. [🎒Homework: Book Series - You Don't Know JS - Book #2 Scope & Closures - Ch 5]((https://github.com/getify/You-Dont-Know-JS/blob/2nd-ed/scope-closures/README.md))
1. [🎒Homework: Book Series - Eloquent JavaScript - Chapter 4 + Exercises ](https://eloquentjavascript.net/Eloquent_JavaScript.pdf)
1. [Debugging](/debugging/debugging.md)
1. [Review: Git and Github](/git/git-version-control-part2.md)
1. [Test-Driven Development (TDD) & Testing Mindset](/testing-and-tdd/testing-mindset.md)
1. [Article: Why Learning to Code is So Damn Hard" By Erik Trautman](https://www.thinkful.com/blog/why-learning-to-code-is-so-damn-hard/)
1. [🎒Homework: Book Series - You Don't Know JS - Book #2 Scope & Closures - Ch 6](https://github.com/getify/You-Dont-Know-JS/blob/2nd-ed/scope-closures/README.md)
1. [🎒Homework: Book Series - Eloquent JavaScript - Chapter 5 + Exercises](https://eloquentjavascript.net/Eloquent_JavaScript.pdf)
1. [Positive and Rational Thinking](https://www.youtube.com/watch?v=KjDfnUaFKCE)
...
1. [🎒Homework: Book Series - You Don't Know JS - Book #3 Objects & Classes - Ch 1 & 2](https://github.com/getify/You-Dont-Know-JS/blob/2nd-ed/objects-classes/README.md)
1. [🎒Homework: Book Series - Eloquent JavaScript - Chapter 6 + Exercises](https://eloquentjavascript.net/Eloquent_JavaScript.pdf)
1. [Dates in JavaScript](datetime/datetime.md)
...
1.  [🎒Homework: Book Series - You Don't Know JS - Book #3 Objects & Classes - Ch 3 & 4](https://github.com/getify/You-Dont-Know-JS/blob/2nd-ed/objects-classes/README.md) 
1. [JS Coding Challenges](/javascript/basic-js-practice.md)
...
1. [Begin HTML/JS Games project](/projects/js-html-games.md) 
...
1. [Portfolio Project: Incorporating a11y and JQuery](/projects/portfolio/portfolio-webpage-2.md)
1. [🎒Homework YDKJS Book #3 Objects & Classes - through the end including (Ch 6 & Appendix A)](https://github.com/getify/You-Dont-Know-JS/blob/2nd-ed/objects-classes/README.md)
...
1.  [Giving Presentations](https://github.com/Techtonica/curriculum/blob/master/giving-presentations/giving-presentations.md) 
1. [Tips in Tech](/welcome-tips-rules/tech-industry-tips.md)
1. [🎒Homework EJS - Ch 7 (Robot) + write your own version of buildGraph](https://eloquentjavascript.net/Eloquent_JavaScript.pdf)
...
1. [🎒Homework CS50: Intro to Programming video](https://youtu.be/y62zj9ozPOM)
1. [ 🎒Homework EJS Chapter 7 - Rewrite the "buildGraph" function in ES5 (no arrow function etc) page 118](https://eloquentjavascript.net/Eloquent_JavaScript.pdf)



### Week 5 - Eventonica & Advanced JavaScript

1. [Intro to Eventonica](/projects/eventonica/README.md)
1. [Eventonica Project Part 1: Objects](/projects/eventonica/eventonica-part1-objects.md)
1. [🎒Homework Mostly Adequate Guide to Functional Programming Ch 1-3](https://mostly-adequate.gitbooks.io/mostly-adequate-guide/)
1. [Eventonica Project Part 2:  Add Jasmine Tests](/projects/eventonica/eventonica-part2-testing.md)
1. [Eventonica Project Part 3: Build UI with jQuery](/projects/eventonica/eventonica-part3-jquery-ui.md)
1. [🎒Homework Eloquent JavaScript - Ch 8 Errors ](https://eloquentjavascript.net/Eloquent_JavaScript.pdf)
1. [Jasmine Pair Activity](/testing-and-tdd/jasmine-pair-activity.js)
1. [ 🎒Homework Eloquent JavaScript - Ch 9 Regex](https://eloquentjavascript.net/Eloquent_JavaScript.pdf)
1.  [JavaScript 8 - Regular Expressions / RegEx](/javascript/javascript-8-regex.md)
1. [Regex Crossword](https://regexcrossword.com/challenges/tutorial/puzzles/1)
1. [Recursion](/recursion/recursion.md)
1. [🎒Homework Eloquent JavaScript Ch. 11 - Async](https://eloquentjavascript.net/Eloquent_JavaScript.pdf)
1. [JavaScript 9 - Async, Callbacks, Promises](/javascript/javascript-9-async.md)
1. [Node.js](/node-js/node-js.md)
1. [ Eloquent JavaScriptCh. 10 - Modules](https://eloquentjavascript.net/Eloquent_JavaScript.pdf)
1. [MAGFP Ch 4 Currying and Ch 5 Composing](https://mostly-adequate.gitbooks.io/mostly-adequate-guide/ch04.html) 



### Week 6 - Server-Side Web (HTTP, Servers, API)
...
1. [JSON vs Object Literal](http://benalman.com/news/2010/03/theres-no-such-thing-as-a-json/)
1. [APIs & JSON](/api/apis-and-json.md)
1. [AJAX Lesson (Calling APIs from the Browser)](https://github.com/Techtonica/curriculum/blob/master/ajax/ajax.md)
...
1. [ Week 6 Assessment](/objectives/week-6-assessment.md)
1. [REST API's ](/api/REST-API.md)
1. [Pair Activity - Build a Tiny REST API](/projects/mailing-list-rest-api.md)
1. [Eventonica Part 5: Add Express backend](/projects/eventonica/eventonica-part5-express-backend.md)
1. [IRL Slides: Intro to DB ](https://docs.google.com/presentation/d/1oMn7IsFa5wf5aGcdsGf8ba3NdydYRO091maTJLxTb_E)
1. [Relational Databases](/databases/relational-databases.md)
1. [Install PostgreSQL](/databases/installing-postgresql.md)
1. [Data Modeling Part 1 ](/databases/data-modeling-1.md)
1.  [SQL Part 1](/databases/sql-1.md)


### Week 8 - React Fundamentals

1. [Data Modeling Part 2](/databases/data-modeling-2.md)
1. [SQL Part 2](/databases/sql-2.md)
1. [🎒Homework SQL Practice - SQL Bolt Lessons 1-8](https://sqlbolt.com/)
1. [🎒Homework Building Confidence](/professionalism/building-confidence.md)
1. [🎒Homework Underrepresented in tech resources](/underrepresented-in-tech-resources/underrepresented-in-tech.md)
1. [Eventonica Part 6 - Postgres DB](/projects/eventonica/eventonica-part6-postgres.md)
1. [React Part 1](/react-js/react.md) 
1. [Adding Integration Testing to your projects](/testing-and-tdd/integration-testing.md)
1.  [Pair Activity: React Tic Tac Toe](https://reactjs.org/tutorial/tutorial.html)


### Week 9: React Eventonica

1. [.env files](/command-line/env.md)
1. [Solo React Assignment](/projects/react-tweeter.md)
1. [Eventonica- React on the Frontend](/projects/eventonica/eventonica-react.md)
1. [Enzyme Testing](/testing-and-tdd/enzyme-testing.md)
1. [Code Linting with ESLint ](/javascript/eslint.md)

 
### Week 10: Full Stack Practice & Assessment

1. [PERN Stack App](/projects/mern-pern-project.md)
...
1. [Final Project Overview](/projects/final-project)
1. [🎒Homework Create 20 final project ideas](/projects/final-project/selecting-your-project.md#idea-generation---alone)
...
1. [Review Whiteboarding](/interviewing/whiteboarding.md)
...
1. [Take-home Problems: The Ultimate Guide](https://www.fullstackinterviewing.com/2018/02/02/the-ultimate-guide-to-kicking-ass-on-take-home-coding-challenges.html)
1. [Front End Take-home Challenge](/projects/take-home-problems/frontend.md)
1. [Career Week: Technical Writer](/roles-in-tech/technical-writing.md)
...
1. [Career Week: Data Science, Data Engineer](/roles-in-tech/data-science.md)
1. [Career Week: Security Engineer](/roles-in-tech/security.md)
1. [Career Week: QA Engineer](/roles-in-tech/qa.md)
1. [Career Week: Developer Advocate/Evangelist](/roles-in-tech/developer-advocate.md)
...
1. [Career Week: DevOps Engineer](/roles-in-tech/dev-ops.md)


### Week 14 - Project Prep Week & Electives

1. [Intro to Security in Web Development](/security/web-security.md)
1. [OAuth 2.0/Auth0](/oauth/o-auth.md)
1. [Optimizing your React/Node Project](/optimization/optimizing-your-react-node-project.md)
...
1. [Mobile App Development](mobile-development/mobile-development.md)
