...
- Connect to Postgres with the commandline client, then:
  ...
  - Execute a few queries to retrieve data, as guided by instructor or volunteers.  (While this will likely be review of content in the [SQL](https://github.com/Techtonica/curriculum/blob/master/SQL/sql.md) lesson plan, practice will help sharpen these skills.)
...
**Activity #3**
Create the tables you've created based on your data models.
