...
These assignments are to prepare you for starting full-time at Techtonica. There will be a study group each week where volunteers, mentors, and your peers can help. Be sure to plan ahead and pace yourself, each day’s work load is full and a good indication of the level of work expectation and pacing that will go into each day of learning in the program. Mark off your work in your pre-work checklist.
...
- [ ] Read and practice with the [article Javascript String Functions](https://stephen-furlani.notion.site/Javascript-String-Functions-fccff1bce23f4b2dbcfac0d1ea50a814) (thanks to volunteer Stephen Furlani for the contribution)
...
- [ ] Complete and submit [exercises 1 to 8 from the prework folder](https://github.com/Techtonica/curriculum/tree/main/prework) via your prework repo's GitHub link shared on your Pre-Work checklist
- [ ] Complete and submit the 4 task in the [Javascript Fundamentals: Objects](https://javascript.info/object#tasks) website via your prework repo's GitHub link shared on your Pre-Work checklist
